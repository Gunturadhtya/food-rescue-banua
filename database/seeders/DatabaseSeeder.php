    ...
    public function run(): void
    {
        ...
        $shopData = [
            ...
            [
                ...
                'shop_name' => 'Amplang H. Kadir',
                'slug' => 'amplang-h-kadir',
                'description' => 'Crispy and savory traditional fish crackers (amplang) from Banjarmasin.',
            ...
            [
                'owner_name' => 'Melayu Snack Owner',
                'email' => 'melayusnack@example.com',
                'shop_name' => 'Keripik Pisang Kampung Melayu',
                'slug' => 'keripik-pisang-melayu',
                'description' => 'Sweet and crispy traditional banana chips made from local bananas.',
                'address' => 'Jl. Kampung Melayu Darat, Banjarmasin',
            ],
            [
                'owner_name' => 'Kue Kering Owner',
                'email' => 'kuekering@example.com',
                'shop_name' => 'Kue Kering Lapangan Tembak',
                'slug' => 'kue-kering-tembak',
                'description' => 'Assorted delicious homemade cookies and traditional pastries, perfect for snacks.',
                'address' => 'Jl. Hasan Basri, Banjarmasin',
            ],
            [
                'owner_name' => 'Rahmah Owner',
                'email' => 'rahmah@example.com',
                'shop_name' => 'Abon Haruan Ibu Rahmah',
                'slug' => 'abon-haruan-rahmah',
                'description' => 'Authentic Banjar shredded snakehead fish (abon haruan), savory and perfect for long storage.',
