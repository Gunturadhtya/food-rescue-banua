...
export default function Register({ passwordRules }: Props) {
    return (
        <div className="fixed inset-0 z-[9999] flex min-h-screen w-full overflow-y-auto bg-[#FDF8F0] font-sans">
            <Head title="Register" />
                            ...
                            <>
                                ...
                                <div className="mt-2 text-center text-xs font-medium text-gray-500">
                                    ...
                                    <TextLink
                                        href={login()}
                                        tabIndex={6}
                                        className="font-bold text-[#C34A15] hover:underline"
                                    >
                                        Log In
                                    </TextLink>
                                </div>
            ...
            <div className="relative hidden w-1/2 lg:block">
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-12 text-white">
                    <div className="text-right text-xl font-extrabold tracking-wider italic">
                        Food Rescue Banua
                    </div>
                    <div className="mb-12">
                        <h1 className="text-right text-5xl leading-[1.15] font-bold tracking-tight">
                            Rescue Food,
                            <br />
                            Save Money
                        </h1>
