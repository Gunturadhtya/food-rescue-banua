...
export default function Home() {
    const rescues = [
        { name: 'Fore', distance: '0.8 km away', discount: 'Diskon 70%', price: 'Rp18.000', image: '/images/fore.jpg' },
        { name: 'Janji Jiwa', distance: '1.2 km away', discount: 'Diskon 70%', price: 'Rp15.000', image: '/images/jiwa.jpg' },
        { name: 'Mochigo', distance: '2.1 km away', discount: 'Diskon 70%', price: 'Rp15.000', image: '/images/mochigo.jpg' },
        { name: 'Crystal Bakery', distance: '1.1 km away', discount: 'Diskon 70%', price: 'Rp25.000', image: '/images/crystal.jpg' },
    ];
            ...
            <main className="px-12 py-6">
                ...
                <section className="py-12">
                    ...
                    <div className="grid grid-cols-4 gap-6">
                        {rescues.map((item, i) => <RestaurantCard key={i} {...item} />)}
                    </div>
                </section>
            </main>
