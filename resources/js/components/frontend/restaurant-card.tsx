...
export function RestaurantCard({
    ...
    return (
        <div className="rounded-3xl bg-white p-4 shadow-sm">
            ...
            <p className="mb-4 text-sm text-gray-400">{distance}</p>
            <div className="flex items-center justify-between">
                <span className="text-sm font-bold text-[#C34A15]">
                    {price}
                </span>
                <button className="rounded-full bg-gray-100 px-3 py-2 text-[10px] font-bold">
                    WAITING FOR 5 PM
                </button>
            </div>
        </div>
